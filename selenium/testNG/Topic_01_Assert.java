...
public class Topic_01_Assert {
	...
	public void TC_01() {
		...
		Assert.assertEquals(driver.findElement(By.id("advice-required-entry-email")).getText(), "This is a require field.");
		...
		Assert.assertTrue(benefitText.contains("Views and track orders and more"));
	}
